<?php
/**
 * Functions for handling WordPress import to make it compatible with WooCommerce
 *
...
if ( ! function_exists( 'afl_woocommerce_import_start' ) ):
function afl_woocommerce_import_start() {
...
if ( ! function_exists( 'afl_clear_import' ) ):
function afl_clear_import()
{
	remove_all_actions( 'import_start', 10);
	remove_all_actions( 'import_end', 	10);
	afl_temp_products();
	add_action('import_start', 'afl_woocommerce_import_start');
}

add_action('afl_import_hook','afl_clear_import');
endif;

if ( ! function_exists( 'afl_temp_products' ) ):
function afl_temp_products()
{
